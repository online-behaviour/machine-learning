...
"""
    ...
    usage: select-active.py -d dataFile -p probFile [-c|-r|-e|-l|-m|-E] [-R]
...
USAGE = "usage: "+COMMAND+" -p probFile -d dataFile [-c|-r|-e|-l|-m|-E] [-R]"
SAMPLESIZE = 4952
...
try: options = getopt.getopt(sys.argv,"cd:eElmp:rR",[])
